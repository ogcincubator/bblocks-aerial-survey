...
# Aerial Survey Postprocessing (Schema)

`ogc.domain.aerial-survey.survey-process-prov` *v0.1*

Provenance model for describing post processing undertaken
...
description: Process Model for UAV data processing based on the SOSA Observation (or
...
* Path: `_sources/survey-process-prov`
